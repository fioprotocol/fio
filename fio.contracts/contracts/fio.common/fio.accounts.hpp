...
namespace fioio {
    ...
    #define MAX_ADDADDRESS_TRANSACTION_SIZE 512
    #define MAX_SETDOMPUB_TRANSACTION_SIZE 128
    #define MAX_BIND2EOSIO_TRANSACTION_SIZE 86
    #define MAX_BURNEXPIRED_TRANSACTION_SIZE 86
    #define MAX_NEWFUNDSREQUEST_TRANSACTION_SIZE 640
    #define MAX_RECORDOBT_TRANSACTION_SIZE 640
    ...
    #define MAX_REGPROXY_TRANSACTION_SIZE 128
    ...
    #define MAX_VOTEPRODUCER_TRANSACTION_SIZE 128
    ...
    #define MAX_UPDATEAUTH_TRANSACTION_SIZE 256
