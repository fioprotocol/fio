...
trx.actions.
emplace_back( vector<permission_level>{{N(asserter), config::active_name}},
        assertdef{1, "Should Not Assert!"}
);
trx.actions[0].
authorization = {{N(asserter), config::active_name}};

set_transaction_headers(trx);
trx.
sign( get_private_key(N(asserter), "active"), control
->
...
1u);
BOOST_CHECK_EQUAL(result
->action_traces.at(0).receipt.receiver.

to_string(), name(N(asserter))
...
BOOST_CHECK_EQUAL(result
->action_traces.at(0).act.account.
...
BOOST_CHECK_EQUAL(result
->action_traces.at(0).act.name.

to_string(), name(N(procassert))
...
BOOST_CHECK_EQUAL(result
->action_traces.at(0).act.authorization.

size(),

1u );
BOOST_CHECK_EQUAL(result
->action_traces.at(0).act.authorization.at(0).actor.
...
BOOST_CHECK_EQUAL(result
->action_traces.at(0).act.authorization.at(0).permission.

to_string(), name(config::active_name)
...
chain_has_transaction(no_assert_id)
);
const auto &receipt = get_transaction_receipt(no_assert_id);
BOOST_CHECK_EQUAL(transaction_receipt::executed, receipt
.status);
...
set_abi(N(asserter), contracts::asserter_abi()
.
...
name = N();
act.
authorization = vector < permission_level > {{N(f32_tests), config::active_name}};
trx.actions.
push_back(act);

set_transaction_headers(trx);
trx.
sign(get_private_key(N(f32_tests), "active"), control
->
...
name = N();
act.
authorization = vector < permission_level > {{N(f_tests), config::active_name}};
trx.actions.
push_back(act);

set_transaction_headers(trx);
trx.
sign(get_private_key(N(f_tests), "active"), control
->
...
check(i32_overflow_wast,
"i32_trunc_s_f32", "f32.const 2147483648"));
// the maximum value below 2^31 representable in IEEE float32
BOOST_REQUIRE_EQUAL(true,
check(i32_overflow_wast,
"i32_trunc_s_f32", "f32.const 2147483520"));
// -2^31
BOOST_REQUIRE_EQUAL(true,
check(i32_overflow_wast,
"i32_trunc_s_f32", "f32.const -2147483648"));
...
BOOST_REQUIRE_EQUAL(false,
check(i32_overflow_wast,
"i32_trunc_s_f32", "f32.const -2147483904"));

//
//// float32 => uint32
BOOST_REQUIRE_EQUAL(true,
check(i32_overflow_wast,
"i32_trunc_u_f32", "f32.const 0"));
BOOST_REQUIRE_EQUAL(false,
check(i32_overflow_wast,
"i32_trunc_u_f32", "f32.const -1"));
// max value below 2^32 in IEEE float32
BOOST_REQUIRE_EQUAL(true,
check(i32_overflow_wast,
"i32_trunc_u_f32", "f32.const 4294967040"));
BOOST_REQUIRE_EQUAL(false,
check(i32_overflow_wast,
"i32_trunc_u_f32", "f32.const 4294967296"));

//
//// double => int32
BOOST_REQUIRE_EQUAL(false,
check(i32_overflow_wast,
"i32_trunc_s_f64", "f64.const 2147483648"));
BOOST_REQUIRE_EQUAL(true,
check(i32_overflow_wast,
"i32_trunc_s_f64", "f64.const 2147483647"));
BOOST_REQUIRE_EQUAL(true,
check(i32_overflow_wast,
"i32_trunc_s_f64", "f64.const -2147483648"));
BOOST_REQUIRE_EQUAL(false,
check(i32_overflow_wast,
"i32_trunc_s_f64", "f64.const -2147483649"));

//
//// double => uint32
BOOST_REQUIRE_EQUAL(true,
check(i32_overflow_wast,
"i32_trunc_u_f64", "f64.const 0"));
BOOST_REQUIRE_EQUAL(false,
check(i32_overflow_wast,
"i32_trunc_u_f64", "f64.const -1"));
BOOST_REQUIRE_EQUAL(true,
check(i32_overflow_wast,
"i32_trunc_u_f64", "f64.const 4294967295"));
BOOST_REQUIRE_EQUAL(false,
check(i32_overflow_wast,
"i32_trunc_u_f64", "f64.const 4294967296"));


//// float32 => int64
// 2^63
BOOST_REQUIRE_EQUAL(false,
check(i64_overflow_wast,
"i64_trunc_s_f32", "f32.const 9223372036854775808"));
// the maximum value below 2^63 representable in IEEE float32
BOOST_REQUIRE_EQUAL(true,
check(i64_overflow_wast,
"i64_trunc_s_f32", "f32.const 9223371487098961920"));
// -2^63
BOOST_REQUIRE_EQUAL(true,
check(i64_overflow_wast,
"i64_trunc_s_f32", "f32.const -9223372036854775808"));
...
BOOST_REQUIRE_EQUAL(false,
check(i64_overflow_wast,
"i64_trunc_s_f32", "f32.const -9223373136366403584"));

//// float32 => uint64
BOOST_REQUIRE_EQUAL(false,
check(i64_overflow_wast,
"i64_trunc_u_f32", "f32.const -1"));
BOOST_REQUIRE_EQUAL(true,
check(i64_overflow_wast,
"i64_trunc_u_f32", "f32.const 0"));
// max value below 2^64 in IEEE float32
BOOST_REQUIRE_EQUAL(true,
check(i64_overflow_wast,
"i64_trunc_u_f32", "f32.const 18446742974197923840"));
BOOST_REQUIRE_EQUAL(false,
check(i64_overflow_wast,
"i64_trunc_u_f32", "f32.const 18446744073709551616"));

//// double => int64
// 2^63
BOOST_REQUIRE_EQUAL(false,
check(i64_overflow_wast,
"i64_trunc_s_f64", "f64.const 9223372036854775808"));
// the maximum value below 2^63 representable in IEEE float64
BOOST_REQUIRE_EQUAL(true,
check(i64_overflow_wast,
"i64_trunc_s_f64", "f64.const 9223372036854774784"));
// -2^63
BOOST_REQUIRE_EQUAL(true,
check(i64_overflow_wast,
"i64_trunc_s_f64", "f64.const -9223372036854775808"));
...
BOOST_REQUIRE_EQUAL(false,
check(i64_overflow_wast,
"i64_trunc_s_f64", "f64.const -9223372036854777856"));

//// double => uint64
BOOST_REQUIRE_EQUAL(false,
check(i64_overflow_wast,
"i64_trunc_u_f64", "f64.const -1"));
BOOST_REQUIRE_EQUAL(true,
check(i64_overflow_wast,
"i64_trunc_u_f64", "f64.const 0"));
// max value below 2^64 in IEEE float64
BOOST_REQUIRE_EQUAL(true,
check(i64_overflow_wast,
"i64_trunc_u_f64", "f64.const 18446744073709549568"));
BOOST_REQUIRE_EQUAL(false,
check(i64_overflow_wast,
"i64_trunc_u_f64", "f64.const 18446744073709551616"));
}
...
action act;
act.
account = N(entrycheck);
act.
name = N();
act.
authorization = vector < permission_level > {{N(entrycheck), config::active_name}};
trx.actions.
push_back(act);

set_transaction_headers(trx);
trx.
sign(get_private_key(N(entrycheck), "active"), control
->
...
name = N();
act.
authorization = vector < permission_level > {{N(nomem), config::active_name}};
trx.actions.
push_back(act);
trx.
expiration = control->head_block_time();
set_transaction_headers(trx);
trx.
sign(get_private_key(N(nomem), "active"), control
->
...
action act;
act.
account = N(globalreset);
act.
name = name(0ULL);
act.
authorization = vector < permission_level > {{N(globalreset), config::active_name}};
trx.actions.
push_back(act);
}
{
...
set_transaction_headers(trx);
trx.
sign(get_private_key(N(globalreset), "active"), control
->
...
BOOST_FIXTURE_TEST_CASE( big_memory, TESTER
) try {
produce_blocks(2);
...
set_code(N(bigmem), biggest_memory_wast_f
.
...
name = N();
act.
authorization = vector < permission_level > {{N(bigmem), config::active_name}};
trx.actions.
push_back(act);

set_transaction_headers(trx);
trx.
sign(get_private_key(N(bigmem), "active"), control
->
...
BOOST_FIXTURE_TEST_CASE( table_init_tests, TESTER
) try {
produce_blocks(2);
...
BOOST_FIXTURE_TEST_CASE( lotso_globals, TESTER
) try {
produce_blocks(2);
...
set_abi(N(noop), contracts::noop_abi()
.
...
name = N(anyaction);
act.
authorization = vector < permission_level > {{N(noop), config::active_name}};

act.
data = abi_ser.variant_to_binary("anyaction", mutable_variant_object()
                                         ("from", "noop")
                                         ("type", "some type")
...
trx.actions.
emplace_back(std::move(act)
);

set_transaction_headers(trx);
trx.
sign(get_private_key(N(noop), "active"), control
->
...
name = N(anyaction);
act.
authorization = vector < permission_level > {{N(alice), config::active_name}};
...
set_transaction_headers(trx);
trx.
sign(get_private_key(N(alice), "active"), control
->
...
trx.actions.
emplace_back( vector<permission_level>{{config::system_account_name, config::active_name}},
        newaccount{
...
set_transaction_headers(trx);
trx.
sign( get_private_key(config::system_account_name, "active"), control
->
...
BOOST_TEST(fc::json::to_string(pretty_output)
...
BOOST_FIXTURE_TEST_CASE( check_big_deserialization, TESTER
) try {
produce_blocks(2);
create_accounts( {
N(cbd)
...
for(
unsigned int i = 0;
i<wasm_constraints::maximum_section_elements-2; i++)
ss << "  (func " << "$AA_" << i << ")";
ss << ")";
...
for(
unsigned int i = 0;
i<wasm_constraints::maximum_section_elements;
i++)
ss << "  (func " << "$AA_" << i << ")";
ss << ")";
...
for(
unsigned int i = 0;
i<wasm_constraints::maximum_code_size;
i++)
ss << "  (drop (i32.const 3))";
ss << "))";

BOOST_CHECK_THROW(set_code(N(cbd), ss.str().c_str()), fc::assert_exception
); // this is caught first by MAX_SIZE_OF_ARRAYS check
produce_blocks(1);
...
for(
unsigned int i = 0;
i<wasm_constraints::maximum_func_local_bytes-1; i++)
ss << 'a';
ss << "\")";
ss << "(export \"apply\" (func $apply))";
ss << "  (func $apply  (param $0 i64)(param $1 i64)(param $2 i64))";
...
for(
unsigned int i = 0;
i<wasm_constraints::maximum_func_local_bytes;
i++)
ss << 'a';
ss << "\")";
ss << "(export \"apply\" (func $apply))";
...
account = N(tbl);
act.
authorization = vector < permission_level > {{N(tbl), config::active_name}};
trx.actions.
push_back(act);
set_transaction_headers(trx);
trx.
sign(get_private_key(N(tbl), "active"), control
->
...
action act;
act.
name = eosio::chain::wasm_constraints::maximum_table_elements + 54334;
act.
account = N(tbl);
act.
authorization = vector < permission_level > {{N(tbl), config::active_name}};
...
BOOST_CHECK_EXCEPTION(push_transaction(trx), eosio::chain::wasm_execution_error,
[](
...
BOOST_FIXTURE_TEST_CASE( lotso_stack_1, TESTER
) try {
produce_blocks(2);
...
BOOST_FIXTURE_TEST_CASE( lotso_stack_2, TESTER
) try {
produce_blocks(2);
...
BOOST_FIXTURE_TEST_CASE( lotso_stack_3, TESTER
) try {
produce_blocks(2);
...
name = N();
act.
authorization = vector < permission_level > {{N(stackz), config::active_name}};
trx.actions.
push_back(act);

set_transaction_headers(trx);
trx.
sign(get_private_key(N(stackz), "active"), control
->
...
BOOST_FIXTURE_TEST_CASE( lotso_stack_4, TESTER
) try {
produce_blocks(2);
...
for(
unsigned int i = 0;
i<wasm_constraints::maximum_func_local_bytes+4; i+=4)
ss << "(local i32)";
ss << "  )";
ss << ")";
...
BOOST_FIXTURE_TEST_CASE( lotso_stack_5, TESTER
) try {
produce_blocks(2);
...
BOOST_FIXTURE_TEST_CASE( lotso_stack_6, TESTER
) try {
produce_blocks(2);
...
BOOST_FIXTURE_TEST_CASE( lotso_stack_7, TESTER
) try {
produce_blocks(2);
...
BOOST_FIXTURE_TEST_CASE( lotso_stack_8, TESTER
) try {
produce_blocks(2);
...
BOOST_FIXTURE_TEST_CASE( lotso_stack_9, TESTER
) try {
produce_blocks(2);
...
produce_blocks(2);
const vector <uint8_t> proper_wasm = {0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00, 0x01, 0x0d, 0x02, 0x60, 0x03,
                                      0x7f, 0x7f, 0x7f,
                                      0x00, 0x60, 0x03, 0x7e, 0x7e, 0x7e, 0x00, 0x02, 0x0e, 0x01, 0x03, 0x65, 0x6e,
                                      0x76, 0x06, 0x73,
                                      0x68, 0x61, 0x32, 0x35, 0x36, 0x00, 0x00, 0x03, 0x02, 0x01, 0x01, 0x04, 0x04,
                                      0x01, 0x70, 0x00,
                                      0x00, 0x05, 0x03, 0x01, 0x00, 0x20, 0x07, 0x09, 0x01, 0x05, 0x61, 0x70, 0x70,
                                      0x6c, 0x79, 0x00,
                                      0x01, 0x0a, 0x0c, 0x01, 0x0a, 0x00, 0x41, 0x04, 0x41, 0x05, 0x41, 0x10, 0x10,
                                      0x00, 0x0b, 0x0b,
                                      0x0b, 0x01, 0x00, 0x41, 0x04, 0x0b, 0x05, 0x68, 0x65, 0x6c, 0x6c, 0x6f};

const vector <uint8_t> malformed_wasm = {0x00, 0x61, 0x03, 0x0d, 0x01, 0x00, 0x00, 0x00, 0x01, 0x0d, 0x02, 0x60, 0x03,
                                         0x7f, 0x7f, 0x7f,
                                         0x00, 0x60, 0x03, 0x7e, 0x7e, 0x7e, 0x00, 0x02, 0x0e, 0x01, 0x03, 0x65, 0x6e,
                                         0x76, 0x06, 0x73,
                                         0x68, 0x61, 0x32, 0x38, 0x36, 0x00, 0x00, 0x03, 0x03, 0x01, 0x01, 0x04, 0x04,
                                         0x01, 0x70, 0x00,
                                         0x00, 0x05, 0x03, 0x01, 0x00, 0x20, 0x07, 0x09, 0x01, 0x05, 0x61, 0x70, 0x70,
                                         0x6c, 0x79, 0x00,
                                         0x01, 0x0a, 0x0c, 0x01, 0x0a, 0x00, 0x41, 0x04, 0x41, 0x05, 0x41, 0x10, 0x10,
...
name = N();
act.
authorization = vector < permission_level > {{N(grower), config::active_name}};
...
set_transaction_headers(trx);
trx.
sign(get_private_key(N(grower), "active"), control
->
...
vector <uint8_t> wasm(greadFunctions_slowness_out_of_memoryData,
                      greadFunctions_slowness_out_of_memoryData + greadFunctions_slowness_out_of_memorySize);
BOOST_CHECK_THROW(set_code(N(fuzzy), wasm), wasm_serialization_error
);
}
{
...
BOOST_FIXTURE_TEST_CASE( getcode_checks, TESTER
) try {
...
set_code(N(bigmaligned), large_maligned_host_ptr_wast_f
.
...
action act;
act.
account = N(bigmaligned);
act.
name = N();
act.
authorization = vector < permission_level > {{N(bigmaligned), config::active_name}};
trx.actions.
push_back(act);
set_transaction_headers(trx);
trx.
sign(get_private_key(N(bigmaligned), "active"), control
->
