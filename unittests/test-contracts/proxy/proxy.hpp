...
// Extacted from fio.token contract:
namespace eosio {
    class [[eosio::contract("fio.token")]] token : public eosio::contract {
    public:
...
public:
    ...
    [[eosio::on_notify("fio.token::transfer")]]
    ...
    void on_error(uint128_t sender_id, eosio::ignore<std::vector < char>>
