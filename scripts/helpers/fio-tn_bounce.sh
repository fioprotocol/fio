#!/bin/bash
#
# fio-tn_bounce is used to restart a node that is acting badly or is down.
# usage: fio-tn_bounce.sh [arglist]
...
# the command line.
#
# in most cases, simply running ./fio-tn_bounce.sh is sufficient.
#
...
bash $EOSIO_HOME/scripts/helpers/fio-tn_down.sh
bash $EOSIO_HOME/scripts/helpers/fio-tn_up.sh "$*"
