...
if [ $mChoice == 1 ]; then
    ...
    ./cleos -u http://localhost:8889 system vproducer prods htjonrkf1lgs r41zuwovtn44 5spujqoyq4ie fioproducerb fioproducerc fioproducerd  -p htjonrkf1lgs@active
