...
namespace IR {
    ...
    struct FromValueType<ValueType::f64> {
        static constexpr uint16_t value = 4;
    };
    ...
    struct ToValueType<0> {
        static constexpr ValueType value = ValueType::any;
    };
    template<>
    ...
    struct ToResultType<0> {
        static constexpr ResultType value = ResultType::none;
    };
    template<>
    struct ToResultType<1> {
        static constexpr ResultType value = ResultType::i32;
    };
    template<>
    struct ToResultType<2> {
        static constexpr ResultType value = ResultType::i64;
    };
    template<>
    struct ToResultType<3> {
        static constexpr ResultType value = ResultType::f32;
    };
    template<>
    struct ToResultType<4> {
        static constexpr ResultType value = ResultType::f64;
    };

    template<ResultType type>
    ...
    struct FunctionType {
        ...
        IR_API static const FunctionType
        *
        get(ResultType
        ret,
