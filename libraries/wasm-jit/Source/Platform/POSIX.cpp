...
namespace Platform {
    ...
    *
    ...
    THREAD_LOCAL sigjmp_buf
    signalReturnEnv;
    THREAD_LOCAL HardwareTrapType
    signalType = HardwareTrapType::none;
    THREAD_LOCAL CallStack
    *
    ...
    *
    ...
    memcpy(&oldSignalReturnEnv, &signalReturnEnv,
    sizeof(jmp_buf));
...
memcpy(&signalReturnEnv, &oldSignalReturnEnv,
sizeof(jmp_buf));
