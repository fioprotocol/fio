    ...
    namespace chain {
        ...
        public:
            ...
            */
            ...
            optional<abi_serializer>
            get_abi_serializer(account_name n, const fc::microseconds &max_serialization_time) const {
                if (n.good()) {
                    try {
            ...
            fc::variant to_variant_with_abi(const T &obj, const fc::microseconds &max_serialization_time) {
                ...
                abi_serializer::to_variant(obj, pretty_output,
                                           [&](account_name n) {
                                               return get_abi_serializer(n, max_serialization_time);
                                           },
