...
namespace eosio {
    namespace chain {
        ...
        public:
            ...
            max_bandwidth_billed_accounts_can_pay(bool force_elastic_limits = false) const;
        ...
        private:
            ...
            void dispatch_action(action_trace &trace, const action &a, account_name receiver, bool context_free = false,
