...
namespace eosio {
    namespace chain {
        ...
        indexed_by<
                ordered_unique < tag <
                by_id>, member<permission_usage_object, permission_usage_object::id_type, &permission_usage_object::id>>
        >
        >;
        ...
        indexed_by<
                ordered_unique < tag <
                by_id>, member<permission_object, permission_object::id_type, &permission_object::id>>,
        ...
        namespace config {
            ...
            struct billable_size<permission_object> { // Also counts memory usage of the associated permission_usage_object
                ...
                static const uint64_t value =
                        (config::billable_size_v<shared_authority> + 64) + overhead;  ///< fixed field size + overhead
            };
        }
    }
} // eosio::chain
...
FC_REFLECT(eosio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)
(auth))
FC_REFLECT(eosio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)
(auth))
