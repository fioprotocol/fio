            ...
            namespace wabt_runtime {
                ...
                struct wabt_apply_instance_vars {
                    ...
                    char *get_validated_pointer(uint32_t offset, uint32_t size) {
                        ...
                        EOS_ASSERT(offset + size <= memory->data.size() && offset + size >= offset,
                ...
                struct intrinsic_registrator {
                    ...
                    intrinsic_registrator(const char *mod, const char *name, const FuncSignature &sig,
                                          intrinsic_fn fn) {
                ...
                public:
                    ...
                    instantiate_module(const char *code_bytes, size_t code_size,
                                       std::vector<uint8_t> initial_memory) override;
 ...
 */
                ...
                inline auto convert_native_to_literal(const wabt_apply_instance_vars &vars, char *ptr) {
                    ...
                    EOS_ASSERT(ptr >= base && ptr < top_of_memory, wasm_execution_error,
                               "returning pointer not in linear memory");
                    Value v;
                    v.i32 = (int) (ptr - base);
 ...
 */
                ...
                struct intrinsic_invoker_impl<Ret, std::tuple<Input, Inputs...>> {
                    ...
                    static Ret
                    translate_one(wabt_apply_instance_vars &vars, Inputs... rest, const TypedValues &args, int offset) {
 ...
 */
                ...
                struct intrinsic_invoker_impl<Ret, std::tuple<array_ptr<T>, size_t, Inputs...>> {
                    using next_step = intrinsic_invoker_impl<Ret, std::tuple<Inputs...>>;
                    using then_type = Ret(*)(wabt_apply_instance_vars &, array_ptr<T>, size_t, Inputs...,
                                             const TypedValues &, int);

                    template<then_type Then, typename U=T>
                    static auto translate_one(wabt_apply_instance_vars &vars, Inputs... rest, const TypedValues &args,
                                              int offset) -> std::enable_if_t<std::is_const<U>::value, Ret> {
                        ...
                        if (reinterpret_cast<uintptr_t>(base) % alignof(T) != 0) {
                            ...
                            return Then(vars, static_cast<array_ptr<T>>(copy_ptr), length, rest..., args,
                                        (uint32_t) offset - 2);
                        }
                        return Then(vars, static_cast<array_ptr<T>>(base), length, rest..., args,
                                    (uint32_t) offset - 2);
                    };
                    ...
                    static auto translate_one(wabt_apply_instance_vars &vars, Inputs... rest, const TypedValues &args,
                        ...
                        if (reinterpret_cast<uintptr_t>(base) % alignof(T) != 0) {
                            ...
                            T *copy_ptr = &copy[0];
                            memcpy((void *) copy_ptr, (void *) base, length * sizeof(T));
                            Ret ret = Then(vars, static_cast<array_ptr<T>>(copy_ptr), length, rest..., args,
                                           (uint32_t) offset - 2);
 ...
 */
                ...
                struct intrinsic_invoker_impl<Ret, std::tuple<null_terminated_ptr, Inputs...>> {
                    using next_step = intrinsic_invoker_impl<Ret, std::tuple<Inputs...>>;
                    using then_type = Ret(*)(wabt_apply_instance_vars &, null_terminated_ptr, Inputs...,
                                             const TypedValues &, int);
 ...
 */
                ...
                struct intrinsic_invoker_impl<Ret, std::tuple<array_ptr<T>, array_ptr<U>, size_t, Inputs...>> {
                    using next_step = intrinsic_invoker_impl<Ret, std::tuple<Inputs...>>;
                    using then_type = Ret(*)(wabt_apply_instance_vars &, array_ptr<T>, array_ptr<U>, size_t, Inputs...,
                                             const TypedValues &, int);
                    ...
                    translate_one(wabt_apply_instance_vars &vars, Inputs... rest, const TypedValues &args, int offset) {
                        ...
                        size_t length = args.at((uint32_t) offset).get_i32();
                        static_assert(std::is_same<std::remove_const_t<T>, char>::value &&
                                      std::is_same<std::remove_const_t<U>, char>::value,
                                      "Currently only support array of (const)chars");
                        return Then(vars, array_ptr_impl<T>(vars, ptr_t, length),
                                    array_ptr_impl<U>(vars, ptr_u, length), length, args, (uint32_t) offset - 3);
                    };
 ...
 */
                ...
                struct intrinsic_invoker_impl<Ret, std::tuple<array_ptr<char>, int, size_t>> {
                    ...
                    using then_type = Ret(*)(wabt_apply_instance_vars &, array_ptr<char>, int, size_t,
                                             const TypedValues &, int);
                    ...
                    static Ret translate_one(wabt_apply_instance_vars &vars, const TypedValues &args, int offset) {
                        ...
                        size_t length = args.at((uint32_t) offset).get_i32();
                        return Then(vars, array_ptr_impl<char>(vars, ptr, length), value, length, args,
                                    (uint32_t) offset - 3);
                    };
 ...
 */
                ...
                struct intrinsic_invoker_impl<Ret, std::tuple<const name &, Inputs...>> {
                    using next_step = intrinsic_invoker_impl<Ret, std::tuple<Inputs...>>;
                    using then_type = Ret (*)(wabt_apply_instance_vars &, const name &, Inputs..., const TypedValues &,
                                              int);
 ...
 */
                ...
                struct intrinsic_invoker_impl<Ret, std::tuple<const fc::time_point_sec &, Inputs...>> {
                    using next_step = intrinsic_invoker_impl<Ret, std::tuple<Inputs...>>;
                    using then_type = Ret (*)(wabt_apply_instance_vars &, const fc::time_point_sec &, Inputs...,
                                              const TypedValues &, int);
 ...
 */
                ...
                struct intrinsic_function_invoker<void, MethodSig, Cls, Params...> {
                    ...
                    template<MethodSig Method>
                    static void_type
                    wrapper(wabt_apply_instance_vars &vars, Params... params, const TypedValues &args, int offset) {
                        class_from_wasm<Cls>::value(vars.ctx).checktime();
                ...
                struct intrinsic_function_invoker_wrapper<Ret (Cls::*)(Params...) const volatile> {
                    using type = intrinsic_function_invoker<Ret, Ret (Cls::*)(
                            Params...) const volatile, Cls, Params...>;
                };
