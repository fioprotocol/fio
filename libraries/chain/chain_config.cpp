...
namespace eosio {
    namespace chain {
        ...
        void chain_config::validate() const {
            ...
            EOS_ASSERT((max_transaction_net_usage - base_per_transaction_net_usage) >=
            ...
            EOS_ASSERT(context_free_discount_net_usage_num <= context_free_discount_net_usage_den,
                       action_validate_exception,
            ...
            EOS_ASSERT(max_transaction_cpu_usage < (max_block_cpu_usage - min_transaction_cpu_usage),
                       action_validate_exception,
