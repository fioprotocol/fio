...
namespace eosio {
    namespace chain {
        ...
        block_state::block_state(const block_header_state &prev,
                ...
                : block_header_state(prev.next(*b, validator, skip_validate_signee)), block(std::move(b)) {}
        ...
        block_state::block_state(pending_block_header_state &&cur,
                ...
                : block_header_state(std::move(cur).finish_next(*b, validator, signer)), block(std::move(b)),
        ...
        block_state::block_state(pending_block_header_state &&cur,
                ...
                : block_header_state(std::move(cur).finish_next(*b, validator, skip_validate_signee)), block(b),
                  trxs(std::move(trx_metas)) {}
