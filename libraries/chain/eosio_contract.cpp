...
//   context.require_write_lock( config::eosio_auth_scope );
        ...
        void apply_eosio_setcode(apply_context &context) {
            ...
            EOS_ASSERT(account.code_version != code_id, set_exact_code,
        ...
        void apply_eosio_updateauth(apply_context &context) {
            ...
            if (permission) {
                ...
                int64_t old_size = (int64_t)(
                        config::billable_size_v < permission_object > +permission->auth.get_billable_size());
