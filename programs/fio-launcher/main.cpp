...
launcher_def::set_options(bpo::options_description &cfg) {
    cfg.add_options()
            ...
            ("p2p-plugin", bpo::value<string>()->default_value("net"),
            ...
            ("nodeos", bpo::value<string>(&eosd_extra_args),
            ...
            ("specific-nodeos", bpo::value < vector < string >> ()->composing(),
...
FC_REFLECT( tn_node_def, (name)(keys)(peers)
(producers))

FC_REFLECT( testnet_def, (name)(ssh_helper)
(nodes))

FC_REFLECT( server_name_def, (ipaddr)(name)
(has_bios) (eosio_home) (instances))

FC_REFLECT( server_identities, (producer)(nonprod)(db)(default_eosio_home)
(ssh))

FC_REFLECT( node_rt_info, (remote)(pid_file)
(kill_cmd))
