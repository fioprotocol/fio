...
namespace eosio {
    ...
    class public_key_history_object
            : public chainbase::object<chain::public_key_history_object_type, public_key_history_object> {
    ...
    using public_key_history_multi_index = chainbase::shared_multi_index_container<
            ...
            indexed_by<
                    ordered_unique<tag<by_id>, BOOST_MULTI_INDEX_MEMBER(public_key_history_object,
