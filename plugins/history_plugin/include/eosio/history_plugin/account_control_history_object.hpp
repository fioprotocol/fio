...
namespace eosio {
    ...
    class account_control_history_object
            : public chainbase::object<chain::account_control_history_object_type, account_control_history_object> {
    ...
    composite_key<account_control_history_object,
            member <
            account_control_history_object, account_name, &account_control_history_object::controlling_account>,
...
FC_REFLECT( eosio::account_control_history_object, (controlled_account)(controlled_permission)
(controlling_account))
