   ...
   api_handle->call_name(vs.at(0).as<in_param0>(), vs.at(1).as<in_param1>(), result_handler);
            ...
            try {
                ...
                //create some test accounts
                {
                    ...
                    //create "T" account
                    {
                        ...
                        trx.actions.emplace_back(vector<chain::permission_level>{{creator, "active"}},
                                                 newaccount{creator, newaccountT, owner_auth, active_auth});
                    }
                ...
                //set newaccountT contract to eosio.token & initialize it
                {
                    ...
                    }
                    {
                        ...
                        act.data = eosio_token_serializer.variant_to_binary("issue",
                                                                            fc::json::from_string(fc::format_string(
                                                                                    "{\"to\":\"${to}\",\"quantity\":\"60000.0000 CUR\",\"memo\":\"\"}",
                                                                                    fc::mutable_variant_object()("to",
                                                                                                                 newaccountT.to_string()))),
                                                                            abi_serializer_max_time);
                        trx.actions.push_back(act);
                    }
    ...
    void txn_test_gen_plugin::set_program_options(options_description &, options_description &cfg) {
        cfg.add_options()
                ...
                ("txn-test-gen-account-prefix", bpo::value<string>()->default_value("txn.test."),
