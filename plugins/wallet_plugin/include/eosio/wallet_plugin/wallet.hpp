 ...
 */
        ...
        public:
            ...
            get_private_key_from_password(string account, string role, string password) const;
            ...
            */
            ...
            try_sign_digest(const digest_type digest, const public_key_type public_key) override;
