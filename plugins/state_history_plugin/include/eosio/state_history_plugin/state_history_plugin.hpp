...
namespace eosio {
    ...
    struct partial_transaction {
        ...
        partial_transaction(const chain::signed_transaction &t)
                : expiration(t.expiration), ref_block_num(t.ref_block_num), ref_block_prefix(t.ref_block_prefix),
                  max_net_usage_words(t.max_net_usage_words), max_cpu_usage_ms(t.max_cpu_usage_ms),
                  delay_sec(t.delay_sec), transaction_extensions(t.transaction_extensions), signatures(t.signatures),
