...
namespace fc {
    ...
    datastream<ST> &
    history_context_serialize_container(datastream<ST> &ds, const chainbase::database &db, const P &context,
    ...
    datastream<ST> &operator<<(datastream<ST> &ds,
        ...
        history_serialize_container(ds, obj.db,
                                    as_type<eosio::chain::shared_vector<eosio::chain::producer_key>>(
                                            obj.obj.producers));
        return ds;
    }
    ...
    datastream<ST> &operator<<(datastream<ST> &ds,
        ...
        fc::raw::pack(ds,
                      make_history_serial_wrapper(obj.db, as_type<eosio::chain::chain_config>(obj.obj.configuration)));
    ...
    template<typename ST>
    datastream<ST> &
    operator<<(datastream<ST> &ds, const history_serial_wrapper<eosio::chain::protocol_state_object> &obj) {
        fc::raw::pack(ds, fc::unsigned_int(0));
    ...
    datastream<ST> &operator<<(datastream<ST> &ds,
        ...
        fc::raw::pack(ds,
                      make_history_serial_wrapper(obj.db, as_type<eosio::chain::permission_level>(obj.obj.permission)));
        fc::raw::pack(ds, as_type<uint16_t>(obj.obj.weight));
        return ds;
    }
    ...
    datastream<ST> &operator<<(datastream<ST> &ds,
        ...
        fc::raw::pack(
                ds, make_history_serial_wrapper(obj.db,
                                                as_type<eosio::chain::resource_limits::ratio>(obj.obj.contract_rate)));
        fc::raw::pack(
                ds, make_history_serial_wrapper(obj.db,
                                                as_type<eosio::chain::resource_limits::ratio>(obj.obj.expand_rate)));
        return ds;
    }
    ...
    datastream<ST> &operator<<(datastream<ST> &ds, const history_serial_wrapper<eosio::chain::action> &obj) {
        ...
        fc::raw::pack(ds, as_type<uint64_t>(obj.obj.name.value));
        history_serialize_container(ds, obj.db,
                                    as_type<std::vector<eosio::chain::permission_level>>(obj.obj.authorization));
    ...
    template<typename ST>
    datastream<ST> &
    operator<<(datastream<ST> &ds, const history_context_wrapper<bool, eosio::chain::action_trace> &obj) {
        ...
        if (obj.obj.receipt) {
            fc::raw::pack(ds,
                          make_history_serial_wrapper(obj.db, as_type<eosio::chain::action_receipt>(*obj.obj.receipt)));
        }
        fc::raw::pack(ds, as_type<uint64_t>(obj.obj.receiver.value));
        ...
        history_serialize_container(ds, obj.db,
                                    as_type<flat_set<eosio::chain::account_delta>>(obj.obj.account_ram_deltas));
    ...
    datastream<ST> &operator<<(datastream<ST> &ds,
        ...
        if (trace.account_ram_delta) {
            fc::raw::pack(
                    ds, make_history_serial_wrapper(obj.db,
                                                    as_type<eosio::chain::account_delta>(*trace.account_ram_delta)));
        }
        ...
        if (trace.failed_dtrx_trace) {
            ...
            fc::raw::pack( //
                    ds, make_history_context_wrapper(
                            obj.db, context,
                            eosio::augmented_transaction_trace{trace.failed_dtrx_trace, obj.obj.partial}));
        }
    ...
    datastream<ST> &operator<<(datastream<ST> &ds,
        ...
        std::pair<uint8_t, bool> context = std::make_pair(eosio::chain::transaction_receipt_header::hard_fail,
                                                          obj.context);
