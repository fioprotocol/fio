...
cmd="programs/cleos/cleos --verbose --url http://$hostname:$nPort --wallet-url http://$hostname:$wPort convert pack_transaction $actualSignedResponse"
echo CMD: $cmd
actualPackedResponse=`$cmd`
ret=$?
