...
#before running this please run the following
...
#../build/bin/cleos -u http://localhost:8889 push action -j fio.system expaddresses '{"actor":"r41zuwovtn44","domain":"expired","address_prefix":"eddieexp","number_addresses_to_add":"1"}' --permission r41zuwovtn44@active
