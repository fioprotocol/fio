...
echo ------------------------------------------
dataJson='{"actor":"${fioactor}","fromfioadd": "adam.brd","tofioadd": "eddie.brd","topubadd": "0xC8a5bA5868A5E9849962167B2F99B2040Cee2031","amount": "1","tokencode": "DAI","metadata": "{\"test\":\"val1\",\"test2\":\"val2\"}"}'
