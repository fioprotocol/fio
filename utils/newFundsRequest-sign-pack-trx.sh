...
dataJson="{\"payer_fio_address\":\"casey.dapix\",\"payee_fio_address\":\"adam.dapix\",\"payee_public_address\":\"0xab5801a7d398351b8be11c439e05c5b3259aec9b\",\"amount\":\"1\",\"token_code\":\"DAI\",\"metadata\":\"{\\"memo\\":\\"Invoice1234\\"}\",\"actor\":\"${fioactor}\"}"
