...
dataJson="{\"fio_address\":\"adam:dapix\",\"actor\":\"htjonrkf1lgs\",\"max_fee\":\"10000000\"\"tpid\":\"\"}"
expectedPackedData=056461706978104208414933a95b
cmd="programs/cleos/cleos --no-auto-keosd --url http://$hostname:$nPort --wallet-url http://$hostname:$wPort  convert pack_action_data eosio unregprod '$dataJson'"
echo CMD: $cmd
