...
# to test this with a block producer accounts
 fio address producera:cryptowallet
 account 5spujqoyq4ie
 pub key   "FIO77odcm3LYr6YduUxf83a4jp4pQ4YvKAjBkHJnLxq2SsgNSc13u",
 private key   "5JMoj56cRYoST3fSyD3bDCNLu7WbMpeGAohmHoaKW8j1vEGfrv2"


fiopubkey="FIO77odcm3LYr6YduUxf83a4jp4pQ4YvKAjBkHJnLxq2SsgNSc13u"
fioprivatekey="5JMoj56cRYoST3fSyD3bDCNLu7WbMpeGAohmHoaKW8j1vEGfrv2"
...
dataJson="{\"multiplier\":1000000,\"actor\":\"5spujqoyq4ie\"}"
expectedPackedData=056461706978104208414933a95b
cmd="programs/cleos/cleos --no-auto-keosd --url http://$hostname:$nPort --wallet-url http://$hostname:$wPort  convert pack_action_data fio.fee setfeemult '$dataJson'"
echo CMD: $cmd
