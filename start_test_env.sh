...
#Create Accounts
cleos -u http://localhost:8889 create account eosio fioname11111 EOS6D6gSipBmP1KW9SMB5r4ELjooaogFt77gEs25V9TU9FrxKVeFb
cleos -u http://localhost:8889 create account eosio fioname22222 EOS6D6gSipBmP1KW9SMB5r4ELjooaogFt77gEs25V9TU9FrxKVeFb
cleos -u http://localhost:8889 create account eosio fioname33333 EOS6D6gSipBmP1KW9SMB5r4ELjooaogFt77gEs25V9TU9FrxKVeFb
cleos -u http://localhost:8889 create account eosio fio.system EOS6D6gSipBmP1KW9SMB5r4ELjooaogFt77gEs25V9TU9FrxKVeFb
cleos -u http://localhost:8889 create account eosio fio.finance EOS6D6gSipBmP1KW9SMB5r4ELjooaogFt77gEs25V9TU9FrxKVeFb
cleos -u http://localhost:8889 create account eosio fio.fee EOS6D6gSipBmP1KW9SMB5r4ELjooaogFt77gEs25V9TU9FrxKVeFb
cleos -u http://localhost:8889 create account eosio fio.common EOS6D6gSipBmP1KW9SMB5r4ELjooaogFt77gEs25V9TU9FrxKVeFb
