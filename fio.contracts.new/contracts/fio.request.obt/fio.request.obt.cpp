...
namespace fioio {
    ...
    public:
        ...
        void recordsend(
            ...
            fio_400_assert(now() <= payernameexp, "payer_fio_address", payer_fio_address,
            ...
            fio_400_assert(now() <= domexp, "payer_fio_address", payer_fio_address,
        ...
        */
        ...
        void newfundsreq(
            ...
            fio_400_assert(now() <= payeenameexp, "payee_fio_address", payee_fio_address,
                           "FIO Address expired", ErrorFioNameExpired);
            ...
            fio_400_assert(now() <= domexp, "payee_fio_address", payee_fio_address,
                           "FIO Domain expired", ErrorFioNameExpired);
        ...
        void rejectfndreq(
            ...
            fio_400_assert(now() <= payernameexp, "payer_fio_address", payerFioAddress,
                           "FIO Address expired", ErrorFioNameExpired);
            ...
            fio_400_assert(now() <= domexp, "payer_fio_address", payerFioAddress,
                           "FIO Domain expired", ErrorFioNameExpired);
